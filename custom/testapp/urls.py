...
from .views import MergeCustomersView,QuickCustomerRegView,SkatingCalculatorView,CompetitionListViev,redirect_user,prelims_results,finals_results,register_competitor,submit_results
